  ...
  >
    ...
    <div class="page-fixed-top-header">
      ...
      <template>
        ...
        <a class="link-item userSelect" target="_blank" href="/hot">
          <span class="tab-item">
            <span class="text"> 热点发现 </span>
          </span>
        </a>
      </template>
      ...
      <div class="float-right userSelect">
        ...
        <div style="margin-right: -18px; margin-left: 24px" class="help-box">
          <nuxt-link class="header-help" to="/purchase" target="_blank">
...
export default {
  ...
  methods: {
    ...
    ifFromHomeJump() {
      ...
      let hFlag = query.hFlag
      if (hFlag) {
        this.$router.push('/folder?folderuid=0')
        return false
      }
      return true
    },
